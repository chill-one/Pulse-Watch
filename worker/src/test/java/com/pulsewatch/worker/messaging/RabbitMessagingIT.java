...
import com.pulsewatch.worker.config.RabbitMqConfig;
...
class RabbitMessagingIT {
    ...
    @Test
    void workerCanConsumeMessageProducedWithSharedCheckTaskContract() {
        CheckTask sent = new CheckTask(
                UUID.randomUUID(),
                UUID.randomUUID(),
        ...
        Object received = rabbitTemplate.receiveAndConvert(RabbitMqNames.CHECK_QUEUE, 5_000);
